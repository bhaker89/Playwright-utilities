...
public class CreateSkuLocation extends AbstractAPI {
    public CreateSkuLocation(){
        super(MimeType.APPLICATION_JSON, "${base_url}"+ ApisPath.CreateSkuLocation, HttpMethodType.POST, true);
