...
public class MapSupplierToVendor extends AbstractAPI {
    public MapSupplierToVendor(){
        super(MimeType.APPLICATION_JSON, "${base_url}"+ ApisPath.MapSupplierToVendor, HttpMethodType.POST, true);
