...
public class AdjustInventoryOnInventoryMaster extends AbstractAPI {
    public AdjustInventoryOnInventoryMaster(){
        super(MimeType.APPLICATION_JSON, "${base_url}"+ ApisPath.AdjustInventoryOnInventoryMaster, HttpMethodType.POST, true);
