...
public class AssignOrdersForPicking extends AbstractAPI {
    public AssignOrdersForPicking(){
        super(MimeType.APPLICATION_JSON, "${base_url}"+ ApisPath.AssignOrdersForPicking, HttpMethodType.POST, true);
